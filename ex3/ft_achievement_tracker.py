...
def ft_achievement_tracker():
    ...
    unique_achievements = Alice.achievements.union(
        Bob.achievements, Charlie.achievements
    )
    common_achievements = Alice.achievements.intersection(
        Bob.achievements, Charlie.achievements
    )
    ...
    rare_charlie = Charlie.achievements.difference(
        Alice.achievements, Bob.achievements
        )
    ...
    print(f"Alice vs Bob common: "
          f"{Alice.achievements.intersection(Bob.achievements)}")
