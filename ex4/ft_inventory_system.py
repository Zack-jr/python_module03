...
def ft_inventory_system():
    ...
    Bob.player_inventory["magic_ring"] = {"rarity" : "rare", "type" : "accessory", "quantity" : 1, "value" : 600}
    ...
    if bob_inventory_value == alice_inventory_value:
        print(f"Most valuable players: Alice ({alice_inventory_value} gold) and Bob ({bob_inventory_value} gold)")
    ...
    if (bob_item_count == alice_item_count):
        print(f"Most items: Alice ({alice_item_count} and Bob ({bob_item_count}))")
